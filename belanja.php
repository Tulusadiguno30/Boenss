          ...
          <div class="product-thumb">
            <a href="detail_produk.php?id=<?php echo $data['id_produk']; ?>" class="link-to-product">
              <div class="img-wrapper">
              	   <img src="admin/produk_img/<?php echo $data['gambar']; ?>" alt="<?php echo $data['nm_produk']; ?>" class="square-img">
              </div>
            </a>
          </div>
          <div class="info">
            ...
            <h4 class="product-title">
              <a href="detail_produk.php?id=<?php echo $data
              ['id_produk']; ?>" class="pr-name">
